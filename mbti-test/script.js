const questions = [ {   question: "1. 나는 새로운 사람들과의 만남을 즐긴다.",        
                        options: {            A: "그렇다",            B: "아니다"        }    },
                    {   question: "2. 나는 일을 계획적으로 처리하는 편이다.",        
                        options: {            A: "그렇다",            B: "아니다"        }    },    
                    {        question: "3. 나는 어려운 문제를 해결하는 것을 좋아한다.",        
                    options: {            A: "그렇다",            B: "아니다"        }    },    
                    {        question: "4. 나는 항상 새로운 아이디어를 생각해내는 편이다.",        
                    options: {            A: "그렇다",            B: "아니다"        }    },    
                    {        question: "5. 나는 규칙을 따르는 것보다 독자적인 생각을 추구하는 편이다.",
                    options: {            A: "그렇다",            B: "아니다"        }    }];
